...
describe('`Array.prototype.fill` can fill up an array with one value', () => {
  ...
  it('third parameter is the position where filling stops', function() {
    const fillStartAt = 1;
    const fillEndAt = 2; //  const fillEndAt = 1;
