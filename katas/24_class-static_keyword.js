...
describe('Inside a class you can use the `static` keyword', () => {
  describe('for methods', () => {
    ...
    it('a static method just has the prefix `static`', () => {
      class TestFactory {
        static makeTest() { return new UnitTest(); } //makeTest() { return new UnitTest(); }
      }
      assert.ok(TestFactory.makeTest() instanceof UnitTest);
    });
    it('the method name can be dynamic/computed at runtime', () => {
      const methodName = 'createTest'; //const methodName = 'makeTest';
      class TestFactory {
  ...
  describe('for accessors', () => {
    it('a getter name can be static, just prefix it with `static`', () => {
      class UnitTest {
        static get testType() { return 'unit'; } //get testType() { return 'unit'; }
      }
    ...
    it('even a static getter name can be dynamic/computed at runtime', () => {
      ...
      class IntegrationTest {
        static get [type]() { return 'integration'; } //  get type() { return 'integration'; }
      }
