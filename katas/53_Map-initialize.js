...
describe('initialize a `Map`', function(){
  ...
  it('init Map with multiple key+value pairs', function() {
    const pair1 = [1, 'one'];
    const pair2 = [2, 'two'];
    const map = new Map([pair1,pair2]); //const map = new Map();
  ...
  it('keys are unique, the last one is used', function() {
    ...
    const pair3 = [1, 'eins'];
    const pair4 = [2, 'two'];
    const map = new Map([pair1, pair2, pair3, pair4]); //const map = new Map([pair3, pair1, pair2, pair4]);
  ...
  it('init Map from an Object, is a bit of work', function() {
    ...
    keys.forEach(key => map.set(key, obj[key])); //keys.forEach(key => map.set());
